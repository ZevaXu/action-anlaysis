...
def action_analyze():
    ...
    false_file_path = download_file(params['openid'], params['wrong_data'], "2")
    ...
    print('分析结束')
    src = upload_file(save_path, params['openid'])
    res = {"score": 90, "describe": [distance_des,angle_des], "src": src}
